function [x,x_full,alpha_est,beta_est] = lsSolnCal(x_aoa,z,x_cal, z_cal, C,x_init,epsilon,max_num_iterations,force_full_calc,plot_progress)
% [x,x_full,alpha_est,beta_est] = lsSolnCal(x_aoa,z,x_cal,z_cal,C,x_init,
