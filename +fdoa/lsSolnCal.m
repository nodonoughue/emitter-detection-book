function [x,x_full,alpha_est,beta_est] = lsSolnCal(x_fdoa, v_fdoa, z,x_cal, z_cal, C,x_init,epsilon,max_num_iterations,force_full_calc,plot_progress,fdoa_ref_idx)
% [x,x_full,alpha_est,beta_est] = lsSolnCal(x_fdoa, v_fdoa, 
