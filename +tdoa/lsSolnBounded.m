function [x,x_full] = lsSolnBounded(x_tdoa,rho,C,x_init,b,epsilon,max_num_iterations,force_full_calc,plot_progress,ref_idx)
% [x,x_full] = lsSolnBounded(x_tdoa,rho,C,x_init,b,epsilon,max_num_iterations,...
...
[x,x_full] = utils.constraints.lsSolnBounded(y,J,C_tilde,x_init,b,...
