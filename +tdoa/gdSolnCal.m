function [x,x_full,alpha_est,beta_est] = gdSolnCal(x_tdoa, z,x_cal, z_cal, C,x_init,a,b,epsilon,max_num_iterations,force_full_calc,plot_progress,tdoa_ref_idx)
% [x,x_full,alpha_est,beta_est] = gdSolnCal(x_tdoa, z,x_cal, z_cal, C,
%                           x_init,a,b,epsilon,max_num_iterations,
