function [x,x_full] = gdSolnFixed(x_tdoa,rho,C,x_init,a,tol,alpha,beta,epsilon,max_num_iterations,force_full_calc,plot_progress,ref_idx)
% [x,x_full] = gdSolnFixed(x_tdoa,rho,C,x_init,a,tol,alpha,beta,epsilon,...
