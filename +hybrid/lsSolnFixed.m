function [x,x_full] = lsSolnFixed(x_aoa,x_tdoa,x_fdoa,v_fdoa,z,C,x_init,a,tol,epsilon,max_num_iterations, force_full_calc, plot_progress, tdoa_ref_idx, fdoa_ref_idx)
% [x,x_full] = lsSolnFixed(x_aoa,x_tdoa,x_fdoa,v_fdoa,z,C,x_init,a,tol,
%               epsilon,numIterations, force_full_calc, plot_progress, 
