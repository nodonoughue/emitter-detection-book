function [x,x_full] = lsSolnBounded(x_aoa,x_tdoa,x_fdoa,v_fdoa,z,C,x_init,b,epsilon,max_num_iterations, force_full_calc, plot_progress, tdoa_ref_idx, fdoa_ref_idx)
% [x,x_full] = lsSolnBounded(x_aoa, x_tdoa, x_fdoa, v_fdoa, z,C,x_init,b,
%                           epsilon,numIterations,force_full_calc, 
...
[x,x_full] = utils.constraints.lsSolnFixed(y,J,C_tilde,x_init,b,...
